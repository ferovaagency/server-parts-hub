  ...
  return (
    <div className="bg-card rounded-xl border overflow-hidden shadow-card hover:shadow-elevated transition-shadow group">
      ...
      <div className="p-4 space-y-2">
        <Link to={`/producto/${product.slug}`}>
          <h3 className="font-semibold text-sm leading-tight hover:text-accent transition-colors line-clamp-2">{product.name}</h3>
        </Link>
        ...
        <div className="flex flex-col gap-2 pt-1">
          <a
            ...
            className="w-full text-center bg-accent text-accent-foreground text-xs font-semibold py-2 rounded-lg hover:bg-orange-light transition-colors"
          >
